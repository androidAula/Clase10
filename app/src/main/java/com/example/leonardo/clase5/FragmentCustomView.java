...
import com.example.leonardo.clase5.Utils.AndroidATCView;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link FragmentCustomView.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentCustomView#newInstance} factory method to
...
public class FragmentCustomView extends Fragment {
     ...
     * @return A new instance of fragment FragmentCustomView.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentCustomView newInstance(String param1, String param2) {
        FragmentCustomView fragment = new FragmentCustomView();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myView.setLabelText("vista modificada");
            }
        });
        return rootView;
    }
